module Generator
  ...
  module Migrator
    attr_accessor :migrated_versions
    attr_accessor :migrated_sections
    attr_accessor :migrated_documents

    attr_accessor :previous_versions
    attr_accessor :previous_sections
    attr_accessor :previous_documents
